...
> Design notes for **creator-audio-subscriber-updates** — a runnable python example that Prepare subscriber updates from creator audio transcripts during a Whisper migration.
...
- **Feature code** — the actual task: creator-audio-editing.
